...
local UICorner_TextButton_4 = Instance.new("UICorner")
local ImageLabel_4 = Instance.new("ImageLabel")
local TextButton_Start_4 = Instance.new("TextButton")
local UICorner_TextButton_Start_4 = Instance.new("UICorner")
...
Global_Arsenal_Frame.Position = UDim2.new(0.190985993, 0, 0.248470008, 0)
Global_Arsenal_Frame.Size = UDim2.new(0, 455, 0, 259)
...
ImageLabel_3.Image = "rbxassetid://10791968284"
...
TextButton_4.Parent = Arsenal_Frame_1
TextButton_4.BackgroundColor3 = Color3.fromRGB(50, 53, 59)
TextButton_4.BorderColor3 = Color3.fromRGB(50, 53, 59)
TextButton_4.Position = UDim2.new(0, -95, 0, 141)
TextButton_4.Size = UDim2.new(0.257999986, 0, 0.181999996, 0)
TextButton_4.Font = Enum.Font.SourceSans
TextButton_4.Text = "Arsenal v4"
TextButton_4.TextColor3 = Color3.fromRGB(255, 255, 255)
TextButton_4.TextScaled = true
TextButton_4.TextSize = 14.000
TextButton_4.TextWrapped = true

UICorner_TextButton_4.CornerRadius = UDim.new(0, 3)
UICorner_TextButton_4.Name = "UICorner_TextButton_4"
UICorner_TextButton_4.Parent = TextButton_4

ImageLabel_4.Name = "ImageLabel_4"
ImageLabel_4.Parent = Arsenal_Frame_1
ImageLabel_4.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
ImageLabel_4.Position = UDim2.new(0.140139505, 0, 0.0323043279, 0)
ImageLabel_4.Size = UDim2.new(0.717641056, 0, 0.693000019, 0)
ImageLabel_4.Image = "rbxassetid://10856148034"

TextButton_Start_4.Name = "TextButton_Start_4"
TextButton_Start_4.Parent = Arsenal_Frame_1
TextButton_Start_4.BackgroundColor3 = Color3.fromRGB(50, 53, 59)
TextButton_Start_4.BorderColor3 = Color3.fromRGB(50, 53, 59)
TextButton_Start_4.Position = UDim2.new(0.253008753, 0, 0.779643297, 0)
TextButton_Start_4.Size = UDim2.new(0.487365693, 0, 0.170513645, 0)
TextButton_Start_4.Font = Enum.Font.SourceSans
TextButton_Start_4.Text = "Start"
TextButton_Start_4.TextColor3 = Color3.fromRGB(255, 255, 255)
TextButton_Start_4.TextScaled = true
TextButton_Start_4.TextSize = 14.000
TextButton_Start_4.TextWrapped = true

UICorner_TextButton_Start_4.Name = "UICorner_TextButton_Start_4"
UICorner_TextButton_Start_4.Parent = TextButton_Start_4
...
local function JBXFT_fake_script() 
...
coroutine.wrap(JBXFT_fake_script)()
local function LQWEM_fake_script() -- TextButton_Start_2.Script_TextButton_Start_1 
...
coroutine.wrap(LQWEM_fake_script)()
local function LCVB_fake_script() 
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		TextButton_Start_4.Visible = false
		ImageLabel_4.Visible = false
	end)
end
coroutine.wrap(LCVB_fake_script)()
local function EDCNK_fake_script() 
...
coroutine.wrap(EDCNK_fake_script)()
local function EAHVV_fake_script() 
...
coroutine.wrap(EAHVV_fake_script)()
local function XSXC_fake_script() 
...
coroutine.wrap(XSXC_fake_script)()
local function SXDOI_fake_script() 
	local script = Instance.new('Script', TextButton_4)

	script.Parent.MouseButton1Click:Connect(function()
		TextButton_Start_4.Visible = true
...
coroutine.wrap(SXDOI_fake_script)()
local function EFKNQIQ_fake_script() 
	local script = Instance.new('Script', TextButton_Start_4)

	script.Parent.MouseButton1Click:Connect(function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/RobloxianRoblox3200/Scripts_Roblox/main/Arsenal_v4.lua"))()
	end)
end
coroutine.wrap(EFKNQIQ_fake_script)()
local function SSWZV_fake_script() 
...
coroutine.wrap(SSWZV_fake_script)()
local function GBCQA_fake_script() 
...
coroutine.wrap(GBCQA_fake_script)()
